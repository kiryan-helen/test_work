							...
							<div class="uofb cf">
								<div class="l_col adrs">
									...
									<form method="get" action="{{route('add')}}">
										<div class="field">
											<label>Name *</label>
											<input type="text" palceholder="" class="vl_empty" name="name" id="name" required/>
										</div>
										<div class="field">
											...
											<select  class="vl_empty" name="city" id="city" >
												...
												<option value = "<?php echo $tmp['id']?>" > <?php echo $tmp['title']?> </option>
												@endforeach
										...
										<div class="field">
											<label>Street</label>
											<input type="text" palceholder="" class="vl_empty"  name="street" required/>
										</div>
										<div class="field">
											<label>House # </label>
											<input type="text" palceholder="House Name / Number" name="house" required/>
										</div>
								...
								<div class="r_col">
									...
									<div class="uo_adr_list">
										@if(isset($adreses)&&$adreses!="")
											@foreach($adreses as $tmp)
											<div class="item">
												<h3><?php echo "$tmp[name] " ?></h3>
												<p><?php 
													echo "$tmp[city], $tmp[area], $tmp[street], $tmp[house]"; 
													if(!empty($tmp['additional_information'])) echo", $tmp[additional_information]"; 
												?></p>
												<div class="actbox">
														<a href="{{route('del', $tmp['id'])}}" class="bcross"></a>
												</div>
											</div>
